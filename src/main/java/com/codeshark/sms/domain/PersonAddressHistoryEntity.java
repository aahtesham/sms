...
@Entity
@Table(name = "person_address_history", schema = "sms", catalog = "")
public class PersonAddressHistoryEntity {
    ...
    private int personAddressHistoryId;
    ...
    @Id
    @Column(name = "person_address_history_id")
    public int getPersonAddressHistoryId() {
        return personAddressHistoryId;
    }

    public void setPersonAddressHistoryId(int personAddressHistoryId) {
    ...
    public boolean equals(Object o) {
        ...
        PersonAddressHistoryEntity that = (PersonAddressHistoryEntity) o;

        if (personAddressHistoryId != that.personAddressHistoryId) return false;
        ...
        if (addressLineTwo != null ? !addressLineTwo.equals(that.addressLineTwo) : that.addressLineTwo != null)
            return false;
        return isCurrent != null ? isCurrent.equals(that.isCurrent) : that.isCurrent == null;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + personAddressHistoryId;
